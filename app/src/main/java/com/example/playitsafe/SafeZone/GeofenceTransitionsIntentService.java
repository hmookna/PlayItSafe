...
public class GeofenceTransitionsIntentService extends IntentService{
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String x  = intent.getStringExtra(SafeZoneActivity.ROUTE_NODE_INTENT);
        RouteNode rNode = (RouteNode) intent.getParcelableExtra (SafeZoneActivity.ROUTE_NODE_INTENT);
...
//                    geofencingEvent.getErrorCode());
        ...
        if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER ||
            ...
            sendNotification(geofenceTransition,
                    ...
                    intent.getIntExtra(SafeZoneActivity.ROUTE_ID_INTENT, 0),
                    intent.getIntExtra(SafeZoneActivity.NODE_ID_INTENT, 0),
                    intent.getIntExtra(SafeZoneActivity.NODE_NUMBER_INTENT, 0));
     ...
     */
    private void sendNotification(int geofenceTransition, String notificationDetails, int routeId, int nodeId, int nodeNumber) {
        // Create an explicit content Intent that starts the main Activity.
        Intent notificationIntent = new Intent(getApplicationContext(), MapsActivity.class);
        notificationIntent.putExtra(SafeZoneActivity.ROUTE_ID_INTENT, Integer.toString(routeId));
        notificationIntent.putExtra(SafeZoneActivity.NODE_ID_INTENT, Integer.toString(nodeId));
        notificationIntent.putExtra(SafeZoneActivity.NODE_NUMBER_INTENT, Integer.toString(nodeNumber));
    ...
    private void intentToMapsActivity(boolean inTheArea){
        Intent localIntent = new Intent(Constants.BROADCAST_ACTION)
                ...
                .putExtra(Constants.EXTENDED_DATA_STATUS, inTheArea);
