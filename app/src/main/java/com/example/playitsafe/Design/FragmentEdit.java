...
public class FragmentEdit extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.activity_editprofile, container, false);
        ...
        editName = (EditText) layout.findViewById(R.id.inputName);
        editEmail = (EditText) layout.findViewById(R.id.inputEmail);
        editPassword= (EditText) layout.findViewById(R.id.inputPassword);
        editMobile= (EditText) layout.findViewById(R.id.inputMobile);
        ...
        edit = (Button) layout.findViewById(R.id.btn_edit);
        ...
        btn_close.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                getFragmentManager().beginTransaction().remove(FragmentEdit.this).commit();
                session.setKeyEdit("");
            }
        });
